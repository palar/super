...
set generaluser_gs_version=*
for %%a in (Dependencies\Downloads\GeneralUser_GS_%generaluser_gs_version%.zip) do set generaluser_gs_setup_file=%%a
set a=%0
set b=%1
set c=%2
set d=%3
...
echo.
7z e %generaluser_gs_setup_file% -o%commonfiles%\%app_folder% "GeneralUser GS v%generaluser_gs_version%.sf2" -r>nul 2>&1
