...
for %%a in (Dependencies\Downloads\%bit%-bit\mini_installer.sync.exe) do set setup_file=%%a
for %%a in (Dependencies\Downloads\mini_installer.sync.exe) do set setup_file=%%a
set a=%0
set b=%1
set c=%2
set d=%3
...
echo.
7z e %setup_file% -o%app_folder% chrome.7z>nul 2>&1
