...
set version=*
for %%a in (Dependencies\Downloads\wordweb%version%.exe) do set setup_file=%%a
set settings_ini=settings.ini
set a=%0
set b=%1
set c=%2
set d=%3
...
cd %app_folder%
cd App
call :del IAccessible2Proxy*.dll
call :ren wweb32new.dll wweb32.dll
type nul>%settings_ini%
cd..
cd..
