...
set app_folder=%app_name: =_%
set commonfiles=CommonFiles
set bit=64
if not defined ProgramFiles(x86) set bit=32
set setup_file=Dependencies\Downloads\Microsoft_Visual_C++_2015-2019_Redistributable.7z
set a=%0
set b=%1
set c=%2
set d=%3
...
echo.
7z e %setup_file% -o%commonfiles%\%app_folder% %bit%-bit\*.dll -r>nul 2>&1
