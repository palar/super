...
set version=*
set bit=64
set temporary_bit=x%bit%
if not defined ProgramFiles(x86) (
	set bit=32
	set temporary_bit=Win%bit%
)
set temporary=fluidsynth-%temporary_bit%
for %%a in (Dependencies\Downloads\fluidsynth-%version%-win%bit%*) do set setup_file=%%a
set a=%0
set b=%1
set c=%2
set d=%3
