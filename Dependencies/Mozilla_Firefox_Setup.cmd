...
for %%a in ("Dependencies\Downloads\%bit%-bit\Firefox Setup %version%.exe") do set setup_file="%%a"
for %%a in ("Dependencies\Downloads\Firefox Setup %version%.exe") do set setup_file="%%a"
set temporary=core
set a=%0
set b=%1
set c=%2
