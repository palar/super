...
set app_folder=filegator
set html=html
set html_apps=%html%\apps
for %%a in (Dependencies\Downloads\filegator_v*.zip) do set setup_file=%%a
set a=%0
set b=%1
set c=%2
set d=%3
...
echo.
7z x %setup_file% -o%html_apps%>nul 2>&1
rd %html_apps%>nul 2>&1
if not exist %html_apps%\%app_folder% goto error
