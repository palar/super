...
set version=*
for %%a in (Dependencies\Downloads\composer%version%.phar) do set phar=%%a
if defined phar set phar=%phar:Dependencies\Downloads\=%
set a=%0
set b=%1
set c=%2
set d=%3
...
:install
if not defined phar goto error
call :uninstall
echo Installing %app_name%...
echo.
robocopy Dependencies\Downloads %app_folder%\App %phar%>nul 2>&1
