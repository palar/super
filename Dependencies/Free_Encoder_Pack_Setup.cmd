...
set app_folder=foobar2000\App
set version=*
for %%a in (Dependencies\Downloads\Free_Encoder_Pack-%version%.exe) do set setup_file=%%a
for %%a in (Dependencies\Downloads\winamp*_full_en-us_redux.exe) do set winamp_setup_file=%%a
set a=%0
set b=%1
set c=%2
set d=%3
...
echo.
7z e %setup_file% -o%app_folder%\encoders fhgaacenc*>nul 2>&1
7z e %winamp_setup_file% -o%app_folder%\encoders Plugins\enc_fhgaac.dll libmp4v2.dll nsutil.dll -y>nul 2>&1
