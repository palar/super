...
for %%a in (Dependencies\Downloads\gimp-%version%%bit%-setup%revision%.exe) do set setup_file=%%a
set a=%0
set b=%1
set c=%2
set d=%3
...
echo.
%setup_file% /DIR=%app_folder%\App /VERYSILENT
if not exist %app_folder% goto error
cd %app_folder%
call :rd App\share\locale
move /y App App_Temp>nul 2>&1
call :md App
move /y App_Temp\uninst App\uninst>nul 2>&1
App\uninst\unins000.exe /VERYSILENT
:install_loop
if exist App goto install_loop
call :ren App_Temp App
cd..
