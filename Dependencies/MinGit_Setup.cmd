...
for %%a in (Dependencies\Downloads\MinGit-%version%-%bit%-bit.zip) do set setup_file=%%a
set a=%0
set b=%1
set c=%2
set d=%3
...
%app_folder%\App\mingw64\bin\busybox.exe --install %app_folder%\App\usr\bin>nul 2>&1
