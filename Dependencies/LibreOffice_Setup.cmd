...
set app_folder=%app_name%Portable
set version=*
for %%a in (Dependencies\Downloads\LibreOfficePortable_%version%_Multilingual*.paf.exe) do set setup_file=%%a
set a=%0
set b=%1
set c=%2
set d=%3
...
echo.
%setup_file% /destination="%apps_dir%\"
rd %app_folder%>nul 2>&1
if not exist %app_folder%\App goto error
