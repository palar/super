...
set app_folder=%app_name:Visual Studio =VS%
set version=*
set bit=x64
if not defined ProgramFiles(x86) set bit=ia32
for %%a in (Dependencies\Downloads\VSCode-win32-%bit%-%version%.zip) do set setup_file=%%a
set a=%0
set b=%1
set c=%2
set d=%3
